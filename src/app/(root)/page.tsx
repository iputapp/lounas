            ...
            >
              <section>
                <div>
                  ...
                  <p>立地するコクーンタワー。</p>
                  <p>その中で過ごす人々</p>
                  <p>のランチを豊かにしたいという思いから</p>
                  <p>「 lounas 」プロジェクトを立ち上げました。</p>
                </div>
                <div>
                  <p>『 lounas 』</p>
                  <p>は学生が手軽に近くの飲食店やカフェから</p>
                  <p>彩り豊かなランチを</p>
                  <p>見つけるのに役立ちます。</p>
                  <p>これは、学生生活をより豊かなものにするための</p>
                  <p>一助となるであろう信念がありました。</p>
                </div>
                <div>
                  <p>これからも、多くの方にご愛顧いただけるようサービスの品質向上に努め</p>
                  <p>豊かな生活を目指し、日々活動してまいります。</p>
                </div>
              </section>
              <section>
                <div>
                  <p>– lounas –</p>
                  <p>
                    <i>Your emotions are our emotions.</i>
                  </p>
                </div>
              </section>
            </motion.div>
